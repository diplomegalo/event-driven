...
1. **Description des étapes** :
    ...
    1. Les **policy** qui permettent de définir les conditions dans lesquelles une commande s'opère. Ces conditions peuvent être des règles métiers, des conditions de validation, des autorisations, etc. Les participants vont inscrire ces conditions sur un Post-its rouge et les positionner à proximité de l'événement.
