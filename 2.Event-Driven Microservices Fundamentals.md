...
- **Partitioning** : les _streams_ peuvent être partitionnés en fonction des besoins de performance. Ce partitionnement offre une opportunité de paralléliser le traitement des événements par les consommateurs.
